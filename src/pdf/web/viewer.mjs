  ...
  scrollPageIntoView({
    ...
    if (!ignoreDestinationZoom) {
      if (scale && scale !== this._currentScale) {
        ...
        this.currentScaleValue = (/* inlined export .DEFAULT_SCALE_VALUE */"1.0");
      }
    }
...
class Toolbar {
  ...
  reset() {
    ...
    this.pagesCount = 0;
    this.pageScaleValue = (/* inlined export .DEFAULT_SCALE_VALUE */"1.0");
...
const PDFViewerApplication = {
  ...
  zoomReset() {
    ...
    this.pdfViewer.currentScaleValue = (/* inlined export .DEFAULT_SCALE_VALUE */"1.0");
  },
  ...
  load(pdfDocument) {
    ...
    const storedPromise = (this.store = new ViewHistory(pdfDocument.fingerprints[0])).getMultiple({
      page: null,
      zoom: (/* inlined export .DEFAULT_SCALE_VALUE */"1.0"),
      scrollLeft: "0",
      scrollTop: "0",
      rotation: null,
